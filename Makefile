...
google-oauth-resource: docker-env
	@set -a; . docker/.env; set +a; \
		./scripts/prepare-google-oauth-resource.sh
...
frontend-tauri-build: google-oauth-resource backend-sidecar-macos tdlib-macos-resource

//! Parses the fixed inherited-runtime command contract.
    ...
    I: Iterator<Item = OsString>,
{
    ...
    if arguments.next().is_some() {
        return Err("Storage runtime arguments are invalid".to_owned());
    }
    ...
    I: Iterator<Item = OsString>,
{
    ...
    arguments
        .next()
        .map(PathBuf::from)
        .ok_or_else(|| "Storage runtime arguments are invalid".to_owned())
}

...
impl NewApiAuditRecord {
    pub fn telegram_chat_action(
        ...
        let path_template = match command_kind {
            "join" => "/api/v1/communications/provider-conversations/join",
            "leave" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/leave",
            "pin" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/pin",
            "unpin" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/unpin",
            "archive" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/archive",
            "unarchive" => {
                "/api/v1/communications/provider-conversations/{telegram_chat_id}/unarchive"
            }
            "mute" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/mute",
            "unmute" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/unmute",
            "folder_add" => {
            ...
            "mark_read" => "/api/v1/communications/provider-conversations/{telegram_chat_id}/read",
            "mark_unread" => {
                "/api/v1/communications/provider-conversations/{telegram_chat_id}/unread"
            }
            _ => "/api/v1/communications/provider-conversations/{telegram_chat_id}/action",
        };

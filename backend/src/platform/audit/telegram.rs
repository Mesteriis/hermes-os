...
impl NewApiAuditRecord {
    ...
    pub fn telegram_account_logout(
        ...
        Self::telegram_account_lifecycle(
            ...
            TelegramAccountLifecycleAudit {
                ...
                method: "POST",
                path_template: "/api/v1/communications/telegram/accounts/{account_id}/logout",
    ...
    pub fn telegram_account_remove(
        ...
        Self::telegram_account_lifecycle(
            ...
            TelegramAccountLifecycleAudit {
                ...
                method: "DELETE",
                path_template: "/api/v1/communications/telegram/accounts/{account_id}",
    ...
    pub fn telegram_message_edit(
        ...
        Self::new(
            ...
            "telegram.message.edit",
            "POST",
            "/api/v1/communications/telegram/messages/{message_id}/edit",
            "telegram_message",
            Some(message_id.into()),
            metadata,
        )
    ...
    pub fn telegram_message_delete(
        ...
        Self::new(
            ...
            "telegram.message.delete",
            "POST",
            "/api/v1/communications/telegram/messages/{message_id}/delete",
            "telegram_message",
            Some(message_id.into()),
            metadata,
        )
    ...
    pub fn telegram_topic_create(
        ...
        Self::new(
            ...
            "telegram.topic.create",
            "POST",
            "/api/v1/communications/telegram/chats/{telegram_chat_id}/topics",
            "telegram_chat",
    ...
    pub fn telegram_topic_close(
        ...
        Self::new(
            ...
            capability,
            "POST",
            "/api/v1/communications/telegram/topics/{topic_id}/close",
            "telegram_topic",
            Some(topic_id.into()),
            metadata,
        )
    ...
    pub fn telegram_message_restore_visibility(
        ...
        Self::new(
            ...
            "telegram.message.restore_visibility",
            "POST",
            "/api/v1/communications/telegram/messages/{message_id}/restore-visibility",
            "telegram_message",
            Some(message_id.into()),
            metadata,
        )
    ...
    pub fn telegram_message_pin(
        ...
        Self::new(
            ...
            "POST",
            "/api/v1/communications/telegram/messages/{message_id}/pin",
            "telegram_message",
            Some(message_id.into()),
            metadata,
        )
    ...
    pub fn telegram_message_mark_read(
        ...
        Self::new(
            ...
            "telegram.message.mark_read",
            "POST",
            "/api/v1/communications/telegram/messages/{message_id}/mark-read",
            "telegram_message",
            Some(message_id.into()),
            metadata,
        )
    ...
    pub fn telegram_message_reaction(
        ...
        let path_template = "/api/v1/communications/telegram/messages/{message_id}/reactions";
        let mut metadata = CapabilityDecision::explicit_user_allowed(
            CapabilityActionClass::LocalWrite,
            capability,
            "explicit_user_confirmation",

...
pub const PACKAGE: &str = "hermes-call-transcription-api";
...
pub const START_CONNECT_PATH_V1: &str =
    "/hermes.call_transcription.v1.CallTranscriptionCommandService/Start";
pub const GET_CONNECT_PATH_V1: &str =
    "/hermes.call_transcription.v1.CallTranscriptionQueryService/Get";
pub const TICKET_CONNECT_PATH_V1: &str =
    "/hermes.call_transcription.v1.CallTranscriptTicketService/IssueRead";
...
pub mod wire {
    include!(concat!(env!("OUT_DIR"), "/hermes.call_transcription.v1.rs"));
}
...
pub fn run_id_v1(operation_id: [u8; 16]) -> [u8; 16] {
    ...
    digest.update(b"hermes.call-transcription.run.v1\0");
...
mod tests {
    ...
    fn public_contract_is_metadata_only_and_not_a_summary_facade() {
        let source = include_str!("../proto/hermes/call_transcription/v1/transcription.proto");
        for required in [

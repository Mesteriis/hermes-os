...
pub fn build_attachment_blob_admission_outbox_record_v1(
    ...
    {
        return Err(ObservationEnvelopeBuildErrorV1::InvalidEnvelope);
    }
    ...
    let payload = attachment_blob_v1::AttachmentBlobAdmissionObservationV1 {
...
mod body_admission_tests {
    ...
    #[test]
    fn blob_admission_events_are_anchor_partitioned_and_schema_bound() {
        ...
        let envelope = decode_envelope_v1(record.exact_bytes()).expect("envelope");
        let payload = attachment_blob_v1::AttachmentBlobAdmissionObservationV1::decode(

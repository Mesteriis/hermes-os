...
pub fn map_zulip_event_to_raw_record(
...
) -> Result<NewRawCommunicationRecord, ZulipEventMappingError> {
    ...
    Ok(NewRawCommunicationRecord::new(
...
pub fn zulip_signal_event_kind(provider_event_type: &str) -> &'static str {
    match provider_event_type {
        "message" => "message",
        "reaction" => "reaction",
...
mod tests {
    ...
    fn maps_message_event_to_raw_signal_ready_record() {
        ...
        assert!(raw_record.raw_record_id.starts_with("raw_zulip_"));
    }

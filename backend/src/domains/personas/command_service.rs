...
use super::api::{Persona, PersonaProjectionError, PersonaProjectionStore};
use super::core::{
...
use super::enrichment::{PersonaEnrichmentError, PersonaEnrichmentStore};
...
use super::identity::{
    PersonaIdentityError, PersonaIdentityReviewCommand, PersonaIdentityReviewCommandResult,
    PersonaIdentityReviewStore,
};
use super::intelligence::{PersonaIntelligenceService, PersonaMessage};
use super::investigator::{
    DossierReviewState, DossierSnapshot, InvestigatorError, PersonaInvestigator,
};
use super::memory::{
    NewRelationshipEvent, PersonaFact, PersonaFactStore, PersonaMemoryCard, PersonaMemoryCardStore,
    PersonaMemoryError, PersonaPreference, PersonaPreferenceStore, RelationshipEvent,
...
impl PersonaCommandService {
    ...
    async fn capture_manual_at(
        ...
        source_ref: String,
        provenance: Value,
    ) -> Result<crate::platform::observations::Observation, PersonaCommandServiceError> {

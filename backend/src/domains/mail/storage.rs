// This file exceeds 700 lines because it groups the mail blob storage with
// attachment metadata, blob path management, and attachment safety scanning
// boundary. These share tight coupling through the blob storage layout and

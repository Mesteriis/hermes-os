...
#[derive(Debug)]
pub(in crate::domains::mail::background_sync) struct SanitizedSyncFailure {
    pub(in crate::domains::mail::background_sync) code: String,
    pub(in crate::domains::mail::background_sync) message: String,
}

impl SanitizedSyncFailure {
    pub(in crate::domains::mail::background_sync) fn from_plan(error: EmailSyncPlanError) -> Self {
    ...
    pub(in crate::domains::mail::background_sync) fn from_vault(error: HostVaultError) -> Self {
        match error {

...
pub(in crate::domains::mail::rules) const EMAIL_RULE_COLUMNS: &str = "rule_id, name, description_nl, conditions_json, actions_json, mode, enabled, match_count, \
     last_matched_at, created_at, updated_at";

pub(in crate::domains::mail::rules) fn row_to_email_rule(
    row: PgRow,

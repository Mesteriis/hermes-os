// This file exceeds 700 lines because it groups the graph store with node
// and edge models, upsert logic, neighborhood traversal, and search
// queries. These are tightly coupled through the graph node/edge SQL
// schema and shared stable-key identity resolution.

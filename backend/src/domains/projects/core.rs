// This file exceeds 700 lines because it groups the project store with its
// associated types (models, errors, queries) that share tight coupling
// through SQL query construction and project linking logic.

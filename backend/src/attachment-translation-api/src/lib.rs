...
pub const PACKAGE: &str = "hermes-attachment-translation-api";
pub const ATTACHMENT_TRANSLATION_OWNER_V1: &str = "attachment_translation";
pub const ATTACHMENT_TRANSLATION_MODULE_ID_V1: &str = "hermes-attachment-translation-runtime";
...
pub const ATTACHMENT_TRANSLATION_COMMAND_CONNECT_PATH_V1: &str =
    "/hermes.attachment_translation.v1.AttachmentTranslationCommandService/Start";
pub const ATTACHMENT_TRANSLATION_QUERY_CONNECT_PATH_V1: &str =
    "/hermes.attachment_translation.v1.AttachmentTranslationQueryService/Get";
pub const ATTACHMENT_TRANSLATION_TICKET_CONNECT_PATH_V1: &str =
    "/hermes.attachment_translation.v1.AttachmentTranslationTicketService/IssueRead";
...
pub mod wire {
    include!(concat!(
        env!("OUT_DIR"),
        "/hermes.attachment_translation.v1.rs"
    ));
}
...
mod tests {
    ...
    fn client_contract_is_exact_private_content_free_and_provider_neutral() {
        ...
        let source = include_str!("../proto/hermes/attachment_translation/v1/translation.proto");

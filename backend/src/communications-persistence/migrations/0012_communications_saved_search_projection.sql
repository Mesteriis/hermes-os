CREATE TABLE hermes_data.communications_saved_query_definitions (
  ...
  account_id BYTEA REFERENCES hermes_data.communications_accounts (account_id)
...
CREATE TABLE hermes_data.communications_saved_query_token_digests (
  saved_search_id BYTEA NOT NULL REFERENCES hermes_data.communications_saved_query_definitions (
    saved_search_id
...
CREATE TABLE hermes_data.communications_saved_query_audit (
...
CREATE INDEX communications_saved_query_definitions_list_v1
  ON hermes_data.communications_saved_query_definitions (

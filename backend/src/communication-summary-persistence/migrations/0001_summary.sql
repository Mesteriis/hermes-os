CREATE TABLE hermes_data.communication_summary_runs (
...
ON hermes_data.communication_summary_runs (
    logical_owner_id,
    state,
    state_revision
);

CREATE TABLE hermes_data.communication_summary_inbox (
    logical_owner_id TEXT NOT NULL,
...
CREATE TABLE hermes_data.communication_summary_outbox (
    logical_owner_id TEXT NOT NULL,
...
ON hermes_data.communication_summary_outbox (
    logical_owner_id,
...
CREATE TABLE hermes_data.communication_summary_realtime (
...
ON hermes_data.communication_summary_realtime (
    logical_owner_id,
    realtime_sequence
);

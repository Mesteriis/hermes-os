...
use crate::application::provider_runtime_contracts::{
    ...
    TelegramTopicLifecycleResponse, TelegramTopicListResponse, WhatsappProviderRuntimeStore,
    WhatsappWebAccountSetupRequest, WhatsappWebAccountSetupResponse, WhatsappWebError,
    WhatsappWebMessage, WhatsappWebSession, get_telegram_topic, lifecycle,
...
pub(crate) struct WhatsappProviderRuntimeApplicationService {
    store: WhatsappProviderRuntimeStore,
}

impl WhatsappProviderRuntimeApplicationService {
    pub(crate) fn new(store: WhatsappProviderRuntimeStore) -> Self {
        Self { store }
    }
    ...
    pub(crate) async fn list_sessions(
        ...
        self.store.list_sessions(account_id, limit).await
    }
...
pub(crate) fn whatsapp_provider_runtime_service(
    ...
    WhatsappProviderRuntimeApplicationService::new(
        crate::application::whatsapp_provider_runtime_store(pool),
    )
}

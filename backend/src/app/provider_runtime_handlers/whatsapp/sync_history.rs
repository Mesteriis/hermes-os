//! Hidden WebView WhatsApp history synchronization endpoint.
...
use super::{
    WhatsAppHistorySyncRequest, WhatsAppHistorySyncResponse, capture_whatsapp_sync_runtime_signal,
...
pub(crate) async fn post_whatsapp_sync_history(
    ...
    let scope = json!({"scope": "history", "provider_chat_id": provider_chat_id});

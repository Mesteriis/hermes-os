...
pub const PACKAGE: &str = "hermes-communications-saved-query-api";
pub const SAVED_SEARCH_CONTRACT_NAME_V1: &str = "communications.saved-search";
pub const SAVED_SEARCH_CONNECT_PATH_V1: &str =
    "/hermes.communications.saved_search.v1.CommunicationsSavedSearchService/Manage";
...
mod wire {
    include!(concat!(
        env!("OUT_DIR"),
        "/hermes.communications.saved_search.v1.rs"
    ));
}

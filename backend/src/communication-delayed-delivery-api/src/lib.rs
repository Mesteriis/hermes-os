...
pub const PACKAGE: &str = "hermes-communication-delayed-delivery-api";
...
pub const COMMUNICATION_DELAYED_DELIVERY_SCHEDULE_CONNECT_PATH_V1: &str =
    "/hermes.communication_delayed_delivery.v1.CommunicationDelayedDeliveryCommandService/Schedule";
pub const COMMUNICATION_DELAYED_DELIVERY_CANCEL_CONNECT_PATH_V1: &str =
    "/hermes.communication_delayed_delivery.v1.CommunicationDelayedDeliveryCommandService/Cancel";
pub const COMMUNICATION_DELAYED_DELIVERY_STATUS_CONNECT_PATH_V1: &str =
    "/hermes.communication_delayed_delivery.v1.CommunicationDelayedDeliveryQueryService/GetStatus";
...
pub mod wire {
    include!(concat!(
        env!("OUT_DIR"),
        "/hermes.communication_delayed_delivery.v1.rs"
    ));
}

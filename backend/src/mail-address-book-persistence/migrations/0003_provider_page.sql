CREATE TABLE hermes_data.mail_address_book_fetch_inbox (
...
ON hermes_data.mail_address_book_fetch_inbox (
    state,
    accepted_at_unix_seconds,
    command_message_id
);

CREATE TABLE hermes_data.mail_address_book_fetch_outbox (
    ...
    FOREIGN KEY (command_message_id, command_id) REFERENCES
        hermes_data.mail_address_book_fetch_inbox (
            command_message_id,
            command_id
        )
);
...
ON hermes_data.mail_address_book_fetch_outbox (

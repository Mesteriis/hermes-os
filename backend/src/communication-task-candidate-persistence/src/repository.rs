...
impl CommunicationTaskCandidatePersistenceV1 {
    ...
    > {
        ...
        let inserted = sqlx::query(
            "INSERT INTO hermes_data.communication_task_candidate_extraction_runs (
    ...
    ) -> Result<CommunicationTaskCandidateInboxResultV1, CommunicationTaskCandidatePersistenceErrorV1>
    {
        ...
        if let Some(row) = sqlx::query(
            "SELECT envelope_sha256, run_id
             FROM hermes_data.communication_task_candidate_extraction_inbox
        ...
        .await?;
        sqlx::query(
            "INSERT INTO hermes_data.communication_task_candidate_extraction_inbox (
    ...
    > {
        ...
        let updated = sqlx::query(
            "UPDATE hermes_data.communication_task_candidate_extraction_runs
...
SELECT logical_owner_id, run_id, operation_id, request_fingerprint,
       ...
       created_at_unix_millis, updated_at_unix_millis
FROM hermes_data.communication_task_candidate_extraction_runs

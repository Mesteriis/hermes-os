CREATE TABLE hermes_data.communication_task_candidate_extraction_runs (
...
ON hermes_data.communication_task_candidate_extraction_runs (
    logical_owner_id,
    state,
    state_revision
);

CREATE TABLE hermes_data.communication_task_candidate_extraction_inbox (
    logical_owner_id TEXT NOT NULL,
...
CREATE TABLE hermes_data.communication_task_candidate_extraction_outbox (
    logical_owner_id TEXT NOT NULL,
...
ON hermes_data.communication_task_candidate_extraction_outbox (
    logical_owner_id,
...
CREATE TABLE hermes_data.communication_task_candidate_extraction_realtime (
...
ON hermes_data.communication_task_candidate_extraction_realtime (
    logical_owner_id,
    realtime_sequence
);

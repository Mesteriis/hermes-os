...
pub(super) fn apply(transaction: &Transaction<'_>) -> Result<(), StoreError> {
    transaction.execute_batch(
        "CREATE TABLE hermes_kernel_module_client_realtime_route_request (
...
mod tests {
    ...
    fn creates_exact_client_realtime_contract_catalog() {
        ...
        connection
            .execute_batch(
                "PRAGMA foreign_keys = ON;
                 ...
                 INSERT INTO hermes_kernel_control_store_metadata VALUES (1, 45);
        ...
        connection
            .execute(
                "INSERT INTO hermes_kernel_module_client_realtime_route_request VALUES (

...
pub(super) fn apply(transaction: &Transaction<'_>) -> Result<(), StoreError> {
    transaction.execute_batch(
        "CREATE TABLE hermes_kernel_module_client_blob_route_request_v43 (
         ...
         INSERT INTO hermes_kernel_module_client_blob_route_request_v43 (
            registration_id,
            capability_id,
            contract_owner,
            contract_name,
         ...
         ALTER TABLE hermes_kernel_module_client_blob_route_request_v43
...
mod tests {
    ...
    fn preserves_existing_routes_and_admits_the_protocol_ceiling() {
        ...
        connection
            .execute_batch(
                "CREATE TABLE hermes_kernel_control_store_metadata (
                 ...
                 INSERT INTO hermes_kernel_control_store_metadata VALUES (1, 42);
        ...
        let preserved: i64 = connection
            .query_row(
                "SELECT COUNT(*) FROM hermes_kernel_module_client_blob_route_request

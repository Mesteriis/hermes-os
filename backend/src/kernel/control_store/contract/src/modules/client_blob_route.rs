//! Exact authenticated client Blob route declared by an owner capability.

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ModuleClientBlobRouteV1 {
...
pub struct ModuleClientBlobContractVersionV1 {
    pub major: u32,
    pub revision: u32,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ModuleClientBlobTransportV1 {
    pub path: String,
    pub max_response_bytes: u64,
}

impl ModuleClientBlobRouteV1 {
    #[must_use]
    pub fn new(
        ...
        contract_version: ModuleClientBlobContractVersionV1,
        contract_schema_sha256: [u8; 32],
        transport: ModuleClientBlobTransportV1,
    ) -> Self {
        Self {

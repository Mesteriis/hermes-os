...
pub struct ModuleClientRealtimeRouteV1 {
...
pub struct ModuleClientRealtimeContractVersionV1 {
    pub major: u32,
    pub revision: u32,
}

impl ModuleClientRealtimeRouteV1 {
    #[must_use]
    pub fn new(
        ...
        contract_version: ModuleClientRealtimeContractVersionV1,
        contract_schema_sha256: [u8; 32],
    ) -> Self {
        Self {

//! Durable authority and fencing for a Kernel-owned platform process.

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PlatformManagedProcessBinding {
    process_id: String,
...
impl PlatformManagedProcessBinding {
    #[must_use]
    pub fn new(
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PlatformManagedProcessLaunch {
    process_id: String,
    binding_revision: u64,
...
impl PlatformManagedProcessLaunch {
    #[must_use]
    pub fn new(
        process_id: impl Into<String>,
        binding_revision: u64,

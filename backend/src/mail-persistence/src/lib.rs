...
pub use schema::{
    ...
    MAIL_STORAGE_BUNDLE_REVISION_V17, MAIL_STORAGE_BUNDLE_REVISION_V18,
    MAIL_STORAGE_BUNDLE_REVISION_V19, MAIL_STORAGE_BUNDLE_REVISION_V20,
    MAIL_STORAGE_BUNDLE_REVISION_V22, mail_storage_bundle_v1,
};

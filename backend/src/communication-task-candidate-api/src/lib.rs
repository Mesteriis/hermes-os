...
pub const PACKAGE: &str = "hermes-communication-task-candidate-api";
...
pub const COMMUNICATION_TASK_CANDIDATE_COMMAND_CONNECT_PATH_V1: &str =
    "/hermes.communication_task_candidate.v1.CommunicationTaskCandidateCommandService/Start";
pub const COMMUNICATION_TASK_CANDIDATE_QUERY_CONNECT_PATH_V1: &str =
    "/hermes.communication_task_candidate.v1.CommunicationTaskCandidateQueryService/Get";
...
pub mod wire {
    include!(concat!(
        env!("OUT_DIR"),
        "/hermes.communication_task_candidate.v1.rs"
    ));
}
...
mod tests {
    ...
    fn client_contract_is_bounded_typed_and_owner_neutral() {
        ...
        let source =
            include_str!("../proto/hermes/communication_task_candidate/v1/task_candidate.proto");

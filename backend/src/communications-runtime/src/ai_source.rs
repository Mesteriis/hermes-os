...
fn persistence_error(_: CommunicationsAiSourceErrorV1) -> CommunicationsAiSourceDeliveryErrorV1 {
...
mod tests {
    ...
    fn wrong_human_owner_is_rejected_before_source_read() {
        let record =
            hermes_communications_ai_source_api::build_communication_reply_source_prepare_outbox_record_v1(
                [7; 16],
                [8; 16],
                3,
                "owner-2",

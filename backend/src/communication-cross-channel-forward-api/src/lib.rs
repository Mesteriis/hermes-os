...
pub const PACKAGE: &str = "hermes-communication-cross-channel-forward-api";
...
pub const COMMUNICATION_CROSS_CHANNEL_FORWARD_REALTIME_EVENT_KIND_V1: &str =
    "communication.cross_channel_forward.status_changed";
pub const COMMUNICATION_CROSS_CHANNEL_FORWARD_COMMAND_CONNECT_PATH_V1: &str = "/hermes.communication_cross_channel_forward.v1.CommunicationCrossChannelForwardCommandService/Start";
pub const COMMUNICATION_CROSS_CHANNEL_FORWARD_QUERY_CONNECT_PATH_V1: &str = "/hermes.communication_cross_channel_forward.v1.CommunicationCrossChannelForwardQueryService/GetStatus";
...
pub mod wire {
    include!(concat!(
        env!("OUT_DIR"),
        "/hermes.communication_cross_channel_forward.v1.rs"
    ));
}
...
mod tests {
    ...
    fn public_contract_is_provider_neutral_and_contains_no_private_body() {
        ...
        let source =
            include_str!("../proto/hermes/communication_cross_channel_forward/v1/forward.proto");

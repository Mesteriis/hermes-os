...
use hermes_review_task_candidate_api::review_task_candidate_approved_contract_reference_v1;
use hermes_reviewed_task_candidate_promotion_core::REVIEWED_TASK_CANDIDATE_PROMOTION_OWNER_V1;

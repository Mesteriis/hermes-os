...
pub const PACKAGE: &str = "hermes-communication-note-candidate-api";
...
pub const COMMUNICATION_NOTE_CANDIDATE_COMMAND_CONNECT_PATH_V1: &str =
    "/hermes.communication_note_candidate.v1.CommunicationNoteCandidateCommandService/Start";
pub const COMMUNICATION_NOTE_CANDIDATE_QUERY_CONNECT_PATH_V1: &str =
    "/hermes.communication_note_candidate.v1.CommunicationNoteCandidateQueryService/Get";
...
pub mod wire {
    include!(concat!(
        env!("OUT_DIR"),
        "/hermes.communication_note_candidate.v1.rs"
    ));
}
...
mod tests {
    ...
    fn client_contract_is_bounded_typed_and_owner_neutral() {
        ...
        let source =
            include_str!("../proto/hermes/communication_note_candidate/v1/note_candidate.proto");

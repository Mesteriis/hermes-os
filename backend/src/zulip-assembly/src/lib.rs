...
use hermes_zulip_runtime::settings::zulip_settings_schema_v1;
use prost::Message;
...
pub fn materialize_zulip_release_assembly_v1(
    ...
    let settings_schema = zulip_settings_schema_v1();
...
mod tests {
    ...
    fn materializes_exact_canonical_artifacts_and_sorted_unsigned_fragment() {
        ...
        assert_eq!(settings_bytes, zulip_settings_schema_v1().encode_to_vec());

use crate::messages::{MessageProjectionStore, ProjectedMessage};
use crate::search::{SearchDocument, SearchIndex, SearchResult};
...
pub enum IndexEmailError {
    ...
    #[error(transparent)]
    Messages(#[from] crate::messages::MessageProjectionError),
}

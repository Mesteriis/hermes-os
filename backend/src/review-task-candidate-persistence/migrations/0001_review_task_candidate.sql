CREATE TABLE hermes_data.review_task_candidate_submissions (
...
ON hermes_data.review_task_candidate_submissions (
    logical_owner_id,
    completed,
    received_at_unix_millis
);

CREATE TABLE hermes_data.review_task_candidate_state (
    logical_owner_id TEXT NOT NULL,
...
ON hermes_data.review_task_candidate_state (
    logical_owner_id,
    state,
    promotion_status,
    review_revision
...
CREATE TABLE hermes_data.review_task_candidate_operations (
    logical_owner_id TEXT NOT NULL,
...
CREATE TABLE hermes_data.review_task_candidate_promotion_inbox (
    logical_owner_id TEXT NOT NULL,
...
CREATE TABLE hermes_data.review_task_candidate_outbox (
    logical_owner_id TEXT NOT NULL,
...
ON hermes_data.review_task_candidate_outbox (
    logical_owner_id,
...
CREATE TABLE hermes_data.review_task_candidate_realtime (
...
ON hermes_data.review_task_candidate_realtime (
    logical_owner_id,
    realtime_sequence
);

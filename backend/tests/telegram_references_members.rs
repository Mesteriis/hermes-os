...
async fn telegram_reference_routes_return_enriched_message_summaries() {
    ...
    let reply_chain_response = app
        ...
        .oneshot(get_request_with_token(
            &format!("/api/v1/communications/provider-messages/{reply_message_id}/reply-chain"),
            LOCAL_API_TOKEN,
        ))
        .await
    ...
    let root_chain_response = app
        .clone()
        .oneshot(get_request_with_token(
            &format!("/api/v1/communications/provider-messages/{root_message_id}/reply-chain"),
            LOCAL_API_TOKEN,
        ))
        .await
    ...
    let leaf_chain_response = app
        .clone()
        .oneshot(get_request_with_token(
            &format!("/api/v1/communications/provider-messages/{leaf_message_id}/reply-chain"),
            LOCAL_API_TOKEN,
        ))
        .await
    ...
    let forward_chain_response = app
        .clone()
        .oneshot(get_request_with_token(
            &format!("/api/v1/communications/provider-messages/{forward_message_id}/forward-chain"),
            LOCAL_API_TOKEN,
        ))
        .await
    ...
    let final_forward_chain_response = app
        ...
        .oneshot(get_request_with_token(
            &format!(
                "/api/v1/communications/provider-messages/{final_forward_message_id}/forward-chain"
            ),
            LOCAL_API_TOKEN,
        ))
        .await
...
async fn telegram_folders_route_returns_projection_backed_filters() {
    ...
    let folders_response = app
        ...
        .oneshot(get_request_with_token(
            &format!(
                "/api/v1/communications/provider-conversation-folders?account_id={account_id}"
            ),
            LOCAL_API_TOKEN,
        ))
        .await

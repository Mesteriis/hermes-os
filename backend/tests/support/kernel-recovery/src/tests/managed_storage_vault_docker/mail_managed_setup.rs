...
use hermes_mail_persistence::{
    GmailOAuthCredentialBindingV1, MAIL_STORAGE_BUNDLE_REVISION_V12, mail_storage_bundle_v1,
};
    ...
    store
        .record_platform_storage_bundle(
            &PlatformStorageBundleV1::new(
                MAIL_OWNER_ID,
                u64::from(MAIL_STORAGE_BUNDLE_REVISION_V12),
...
pub(super) fn prepare_mail_runtime(
    ...
    let bundle = store
        .platform_storage_bundle(MAIL_OWNER_ID, u64::from(MAIL_STORAGE_BUNDLE_REVISION_V12))

...
const GMAIL_OAUTH_SCOPE: &str = "openid email https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/gmail.send";
...
fn serve_connection(
    ...
    let response_body = match request_index {
        0 => br#"{"access_token":"managed-mail-gmail-access-v1","refresh_token":"managed-mail-gmail-refresh-v1","expires_in":3600,"token_type":"Bearer","scope":"openid email https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/gmail.send"}"#.as_slice(),
        1 => br#"{"access_token":"managed-mail-gmail-access-v2","refresh_token":"managed-mail-gmail-refresh-v2","expires_in":3600,"token_type":"Bearer","scope":"openid email https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/gmail.send"}"#.as_slice(),
        3 => br#"{"access_token":"managed-mail-gmail-access-v3","refresh_token":"managed-mail-gmail-refresh-v3","expires_in":3600,"token_type":"Bearer","scope":"openid email https://www.googleapis.com/auth/gmail.readonly https://www.googleapis.com/auth/gmail.send"}"#.as_slice(),

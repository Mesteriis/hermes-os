...
signing/notarization ceremony or fails. Unit tests validate the manifest shape
but do not claim notarization; an operator with a release host validates it
with:

...
impl<'a> OrganizationFactory<'a> {
    pub fn new(pool: &'a PgPool) -> Self {
        Self {
            pool,
            display_name: format!("Test Org {}", Uuid::new_v4().to_string().chars().take(8).collect::<String>()),
    ...
    pub async fn create(self) -> Result<hermes_hub_backend::domains::organizations::api::Organization, hermes_hub_backend::domains::organizations::api::OrganizationError> {

...
Дата последнего обновления: 2026-06-13 19:31 CEST
...
* Во frontend остаются крупные shared CSS files (`pages.css` — 1416 строк, `panels.css` — 1780 строк, `app.css` — 990 строк, `sidebar.css` — 841 строк), которые блокируют ownership-based компонентную декомпозицию.

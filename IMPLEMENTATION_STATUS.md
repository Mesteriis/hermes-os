...
Дата последнего обновления: 2026-06-13 19:21 CEST
...
* Во frontend остаются крупные shared CSS files (`pages.css` — 1628 строк, `panels.css` — 1780 строк, `app.css` — 995 строк, `sidebar.css` — 841 строк), которые блокируют ownership-based компонентную декомпозицию.

...
| Telegram | Telegram integration modules, runtime manager, migrations for chats/messages/policies/calls, `/api/v1/telegram/*` routes, Telegram frontend page and production capability target in `docs/domains/telegram-channel.md` / ADR-0091. |

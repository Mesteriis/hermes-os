...
| Decisions and Obligations are not consistent top-level domains. | Tasks, promises, meeting outcomes and follow-ups can blur together. | Write domain specs, then split durable obligations and decisions from task candidates and meeting outcomes. |

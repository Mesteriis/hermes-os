...
| Polygraph engine does not exist. | New evidence cannot be systematically compared against accepted memory. | Write engine spec, then implement contradiction observations and review workflow in a later slice. |

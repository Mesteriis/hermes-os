...
| GET | `/api/v1/communications/messages?channel_kind=whatsapp_web` | Projected WhatsApp message list |
| POST | `/api/v1/integrations/whatsapp/fixtures/messages` | Fixture message ingest |

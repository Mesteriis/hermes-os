...
| Decisions and Obligations are not complete domains. | Meeting outcomes, task candidates, person promises and task evidence exist. | Durable Decisions and Obligations with evidence and review. | Domain specs, then data-model plan. |

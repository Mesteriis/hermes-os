...
| Polygraph engine is target-only. | No dedicated Consistency / Contradiction Engine module, table or review workflow. | Cross-domain engine for contradiction observations and review items. | Engine spec, then implementation plan. |

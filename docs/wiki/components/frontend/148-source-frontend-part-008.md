---
chunk_id: 148-source-frontend-part-008
...
# 148-source-frontend-part-008 — frontend/source
...
- [`frontend/src/domains/communications/queries/telegramBusinessQueries.ts`](../../../../frontend/src/domains/communications/queries/telegramBusinessQueries.ts)
- [`frontend/src/domains/communications/queries/threadInfiniteQuery.boundary.test.ts`](../../../../frontend/src/domains/communications/queries/threadInfiniteQuery.boundary.test.ts)
- [`frontend/src/domains/communications/queries/threadTranslationMutation.boundary.test.ts`](../../../../frontend/src/domains/communications/queries/threadTranslationMutation.boundary.test.ts)
- [`frontend/src/domains/communications/queries/useCommunicationsQuery.ts`](../../../../frontend/src/domains/communications/queries/useCommunicationsQuery.ts)
- [`frontend/src/domains/communications/queries/whatsappBusinessQueries.ts`](../../../../frontend/src/domains/communications/queries/whatsappBusinessQueries.ts)
- [`frontend/src/domains/communications/stores/communications.test.ts`](../../../../frontend/src/domains/communications/stores/communications.test.ts)
- [`frontend/src/domains/communications/stores/communications.ts`](../../../../frontend/src/domains/communications/stores/communications.ts)
- [`frontend/src/domains/communications/types/aiState.ts`](../../../../frontend/src/domains/communications/types/aiState.ts)
- [`frontend/src/domains/communications/types/attachments.ts`](../../../../frontend/src/domains/communications/types/attachments.ts)
- [`frontend/src/domains/communications/types/bilingualReplyFlow.ts`](../../../../frontend/src/domains/communications/types/bilingualReplyFlow.ts)
- [`frontend/src/domains/communications/types/certificates.ts`](../../../../frontend/src/domains/communications/types/certificates.ts)
- [`frontend/src/domains/communications/types/communications.ts`](../../../../frontend/src/domains/communications/types/communications.ts)
- [`frontend/src/domains/communications/types/folders.ts`](../../../../frontend/src/domains/communications/types/folders.ts)
- [`frontend/src/domains/communications/types/mailOperations.ts`](../../../../frontend/src/domains/communications/types/mailOperations.ts)
- [`frontend/src/domains/communications/types/multilingual.ts`](../../../../frontend/src/domains/communications/types/multilingual.ts)
- [`frontend/src/domains/communications/types/personas.ts`](../../../../frontend/src/domains/communications/types/personas.ts)
- [`frontend/src/domains/communications/types/providerChannels.ts`](../../../../frontend/src/domains/communications/types/providerChannels.ts)
- [`frontend/src/domains/communications/types/readReceipts.ts`](../../../../frontend/src/domains/communications/types/readReceipts.ts)
- [`frontend/src/domains/communications/types/savedSearches.ts`](../../../../frontend/src/domains/communications/types/savedSearches.ts)
- [`frontend/src/domains/communications/types/templates.ts`](../../../../frontend/src/domains/communications/types/templates.ts)
- [`frontend/src/domains/communications/views/CommunicationsPage.boundary.test.ts`](../../../../frontend/src/domains/communications/views/CommunicationsPage.boundary.test.ts)
- [`frontend/src/domains/communications/views/useCommunicationsPageController.ts`](../../../../frontend/src/domains/communications/views/useCommunicationsPageController.ts)
- [`frontend/src/domains/communications/views/useMailResourceOverview.ts`](../../../../frontend/src/domains/communications/views/useMailResourceOverview.ts)
- [`frontend/src/domains/communications/views/useMailSyncActions.ts`](../../../../frontend/src/domains/communications/views/useMailSyncActions.ts)
- [`frontend/src/domains/communications/views/useSelectedMessageActions.ts`](../../../../frontend/src/domains/communications/views/useSelectedMessageActions.ts)

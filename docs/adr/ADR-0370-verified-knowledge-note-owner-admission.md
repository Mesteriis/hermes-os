...
exact verified-note contract/core slice. Persistence, managed runtime, assembly,
...
- будущие отдельные `hermes-knowledge-persistence`,
  `hermes-knowledge-runtime` и `hermes-knowledge-assembly` units.

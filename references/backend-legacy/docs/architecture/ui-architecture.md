...
- desktop productivity with keyboard-first operation;
- Android touch/mobile operation over the same product contracts;
- dense but readable information;
- contextual AI actions throughout the product;
- platform-appropriate responsive layouts;
...
Desktop/Android client state should distinguish:
...
Android offline cache and replay cursor are client state, not canonical truth.

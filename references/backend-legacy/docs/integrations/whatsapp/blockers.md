...
[ADR-0182](../../archive/adr/ADR-0182-whatsapp-hidden-webview-runtime-only.md) records the
previous decision. The constraints below are historical until revalidated by

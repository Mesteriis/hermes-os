---
chunk_id: 147-source-frontend-part-007
...
# 147-source-frontend-part-007 — frontend/source
...
- [`frontend/src/domains/communications/queries/mailOperationQueries.ts`](../../../../frontend/src/domains/communications/queries/mailOperationQueries.ts)
- [`frontend/src/domains/communications/queries/mailWorkspaceQueries.ts`](../../../../frontend/src/domains/communications/queries/mailWorkspaceQueries.ts)
- [`frontend/src/domains/communications/queries/messageLocalIntelligence.boundary.test.ts`](../../../../frontend/src/domains/communications/queries/messageLocalIntelligence.boundary.test.ts)
- [`frontend/src/domains/communications/queries/optimisticFolderMessageUpdates.test.ts`](../../../../frontend/src/domains/communications/queries/optimisticFolderMessageUpdates.test.ts)
- [`frontend/src/domains/communications/queries/optimisticFolderMessageUpdates.ts`](../../../../frontend/src/domains/communications/queries/optimisticFolderMessageUpdates.ts)
- [`frontend/src/domains/communications/queries/optimisticFolderUpdates.test.ts`](../../../../frontend/src/domains/communications/queries/optimisticFolderUpdates.test.ts)
- [`frontend/src/domains/communications/queries/optimisticFolderUpdates.ts`](../../../../frontend/src/domains/communications/queries/optimisticFolderUpdates.ts)
- [`frontend/src/domains/communications/queries/optimisticMailUpdates.test.ts`](../../../../frontend/src/domains/communications/queries/optimisticMailUpdates.test.ts)
- [`frontend/src/domains/communications/queries/optimisticMailUpdates.ts`](../../../../frontend/src/domains/communications/queries/optimisticMailUpdates.ts)
- [`frontend/src/domains/communications/queries/outboxInfiniteQuery.boundary.test.ts`](../../../../frontend/src/domains/communications/queries/outboxInfiniteQuery.boundary.test.ts)
- [`frontend/src/domains/communications/queries/outboxStatusStrip.ts`](../../../../frontend/src/domains/communications/queries/outboxStatusStrip.ts)
- [`frontend/src/domains/communications/queries/queryTypes.ts`](../../../../frontend/src/domains/communications/queries/queryTypes.ts)
- [`frontend/src/domains/communications/queries/realtimeMailPatches.ts`](../../../../frontend/src/domains/communications/queries/realtimeMailPatches.ts)
- [`frontend/src/domains/communications/queries/realtimePatchShared.ts`](../../../../frontend/src/domains/communications/queries/realtimePatchShared.ts)
- [`frontend/src/domains/communications/queries/realtimeTelegramMediaPatches.ts`](../../../../frontend/src/domains/communications/queries/realtimeTelegramMediaPatches.ts)
- [`frontend/src/domains/communications/queries/realtimeTelegramParticipantPatches.ts`](../../../../frontend/src/domains/communications/queries/realtimeTelegramParticipantPatches.ts)
- [`frontend/src/domains/communications/queries/realtimeTelegramPatchShared.ts`](../../../../frontend/src/domains/communications/queries/realtimeTelegramPatchShared.ts)
- [`frontend/src/domains/communications/queries/realtimeTelegramPatches.ts`](../../../../frontend/src/domains/communications/queries/realtimeTelegramPatches.ts)
- [`frontend/src/domains/communications/queries/realtimeTelegramTopicPatches.ts`](../../../../frontend/src/domains/communications/queries/realtimeTelegramTopicPatches.ts)
- [`frontend/src/domains/communications/queries/realtimeWhatsAppPatches.ts`](../../../../frontend/src/domains/communications/queries/realtimeWhatsAppPatches.ts)
- [`frontend/src/domains/communications/queries/resourceOverviewInfiniteQuery.boundary.test.ts`](../../../../frontend/src/domains/communications/queries/resourceOverviewInfiniteQuery.boundary.test.ts)
- [`frontend/src/domains/communications/queries/savedSearchInfiniteQuery.boundary.test.ts`](../../../../frontend/src/domains/communications/queries/savedSearchInfiniteQuery.boundary.test.ts)

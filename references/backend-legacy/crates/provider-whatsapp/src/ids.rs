...
pub fn whatsapp_web_session_id(account_id: &str) -> String {
    format!(
...
pub fn whatsapp_web_message_id(account_id: &str, provider_message_id: &str) -> String {
    format!(
...
pub fn whatsapp_web_raw_record_id(
    account_id: &str,
    record_kind: &str,

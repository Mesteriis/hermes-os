...
load_hermes_env() {
	...
	: "${HERMES_CLAMAV_PORT:=33310}"
	: "${HERMES_CLAMAV_ADDR:=127.0.0.1:$HERMES_CLAMAV_PORT}"
	: "${HERMES_CLAMAV_TIMEOUT_SECONDS:=30}"
	: "${HERMES_ATTACHMENT_EXTRACTOR_ENABLED:=true}"
	: "${HERMES_ATTACHMENT_EXTRACTOR_ADDR:=127.0.0.1:8788}"
	...
	export HERMES_CLAMAV_ADDR
	export HERMES_CLAMAV_TIMEOUT_SECONDS
	export HERMES_ATTACHMENT_EXTRACTOR_ENABLED
	export HERMES_ATTACHMENT_EXTRACTOR_ADDR

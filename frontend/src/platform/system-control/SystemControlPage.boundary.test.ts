...
describe('SystemControlPage bootstrap boundary', () => {
	...
	expect(source).toContain("selectedSection === 'architecture'")
	expect(source).toContain('Architecture blockers and status')
	expect(source).toContain('platform architecture status')

import { useKnowledgeSurface } from '../../domains/knowledge/queries/useKnowledgeSurface'
import { createPlannedScreenSurface } from './plannedScreenSurface'

export function useKnowledgeViewSurface() {
  const knowledge = useKnowledgeSurface()
  ...
  return createPlannedScreenSurface({
    ...
    ownerLayer: 'domain',
    surfacePath: knowledge.surfacePath,
    childSurfaces: knowledge.childSurfaces
  })
}

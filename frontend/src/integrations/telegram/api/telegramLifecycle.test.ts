...
describe('telegram lifecycle reference API', () => {
  ...
  it('fetches projected reply chains by message id', async () => {
    ...
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/messages/msg-1/reply-chain')
  })
  ...
  it('fetches projected forward chains by message id', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledOnce()
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/messages/msg-1/forward-chain')
  })
  ...
  it('sends forward commands with a generated command id', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledOnce()
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/messages/msg-forward-1/forward')
  ...
  it('fetches message versions and tombstones by message id', async () => {
    ...
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/messages/msg-1/versions')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/messages/msg-1/tombstones')
  })
  ...
  it('fetches account command rows and message reactions', async () => {
    ...
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/messages/msg-1/reactions')
  })
  ...
  it('posts message-level mark-read against the dedicated Telegram route', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledOnce()
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/messages/msg-read-1/mark-read')
    const [, init] = fetchMock.mock.calls[0]
    expect(init?.method).toBe('POST')

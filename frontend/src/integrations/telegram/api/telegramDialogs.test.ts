...
describe('telegram dialog action API', () => {
  ...
  it('loads projected chat detail and members routes', async () => {
    ...
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/members?limit=25&query=owner&role=admin&cursor=50')
    expect(fetchMock.mock.calls[2][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/members/sync')
  ...
  it('loads projection-backed telegram folders for the selected account', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(1)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/folders?account_id=acc-1')
    expect(fetchMock.mock.calls[0][1].method).toBe('GET')
  })
  ...
  it('posts pin and unpin requests for projected Telegram chats', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(2)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/pin')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/unpin')
  })
  ...
  it('posts archive/mute dialog lifecycle requests', async () => {
    ...
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/archive')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/unarchive')
    expect(fetchMock.mock.calls[2][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/mute')
    expect(fetchMock.mock.calls[3][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/unmute')
  ...
  it('posts add-to-folder dialog lifecycle requests', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(1)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/folders/7')
    expect(fetchMock.mock.calls[0][1]?.method).toBe('POST')
  ...
  it('posts remove-from-folder dialog lifecycle requests', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(1)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/folders/7/remove')
    expect(fetchMock.mock.calls[0][1]?.method).toBe('POST')
    expect(JSON.parse(fetchMock.mock.calls[0][1]?.body as string)).toEqual({
      account_id: 'acc-1',
      provider_chat_id: 'provider-chat-1',
  ...
  it('posts folder reassignment requests for projected Telegram chats', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(1)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/folders/reassign')
    expect(fetchMock.mock.calls[0][1]?.method).toBe('POST')
    expect(JSON.parse(fetchMock.mock.calls[0][1]?.body as string)).toEqual({
      account_id: 'acc-1',
      provider_chat_id: 'provider-chat-1',
  ...
  it('posts participant join and leave lifecycle requests through command routes', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(2)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/join')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/leave')
    for (const [, init] of fetchMock.mock.calls) {
      expect(init.method).toBe('POST')
      expect(JSON.parse(init.body as string)).toEqual({
        account_id: 'acc-1',
  ...
  it('posts local read and unread dialog lifecycle requests', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledTimes(2)
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/read')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/chats/tgchat-1/unread')
    expect(fetchMock.mock.calls[0][1].method).toBe('POST')
    expect(JSON.parse(fetchMock.mock.calls[0][1].body as string)).toEqual({
      account_id: 'acc-1',
      provider_chat_id: 'provider-chat-1',

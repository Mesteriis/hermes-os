...
describe('telegram QR login API', () => {
  ...
  it('calls start, status, password and cancel QR routes', async () => {
    ...
    expect(fetchMock.mock.calls[0][0]).toContain('/api/v1/communications/telegram/login/qr/start')
    expect(fetchMock.mock.calls[1][0]).toContain('/api/v1/communications/telegram/login/qr/qr-1')
    expect(fetchMock.mock.calls[2][0]).toContain('/api/v1/communications/telegram/login/qr/qr-1/password')
    expect(fetchMock.mock.calls[3][0]).toContain('/api/v1/communications/telegram/login/qr/qr-1')

...
export const widgetRegistry: WidgetDefinition[] = [
	...
	widget('persons-list', 'Persons List', ['persons'], 'list', ['list']),
	widget('persons-hero', 'Person Hero', ['persons'], 'detail', ['detail']),
	widget('persons-information', 'Person Information', ['persons'], 'detail', ['detail', 'rail']),
	widget('persons-about', 'About', ['persons'], 'detail', ['detail']),
	widget(
	...
	widget('persons-recent-interactions', 'Recent Interactions', ['persons'], 'detail', ['detail']),
	widget('persons-active-projects', 'Active Projects', ['persons'], 'detail', ['detail', 'rail']),
	widget('persons-ai-summary', 'AI Summary', ['persons'], 'rail', ['rail']),
	widget(

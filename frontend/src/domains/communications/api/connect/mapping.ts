...
export function normalizeDraftStatus(value: string): DraftListResponse['items'][number]['status'] {
  switch (value) {
    case 'scheduled':
    case 'sending':
    case 'sent':
...
export function normalizeOutboxStatus(value: string): CommunicationOutboxItem['status'] {
  switch (value) {
    case 'scheduled':
    case 'sending':
    case 'sent':
...
export function normalizeDisposition(value: string): CommunicationAttachment['disposition'] {
  switch (value) {
    case 'attachment':
    case 'inline':
      return value
...
export function normalizeScanStatus(value: string): CommunicationAttachment['scan_status'] {
  switch (value) {
    case 'clean':
    case 'suspicious':
    case 'malicious':
...
export function normalizeAttachmentScanStatus(value: string): AttachmentScanStatus {
  switch (value) {
    case 'clean':
    case 'suspicious':
    case 'malicious':
...
export function normalizeBulkMessageAction(value: string): BulkMessageActionResponse['action'] {
  switch (value) {
    case 'mark_read':
    case 'mark_unread':
    case 'archive':

...
import { whatsAppMessengerComposerPreset, type MessengerComposerCapability } from './messengerComposer'
...
const preset = computed(() => whatsAppMessengerComposerPreset(props.conversation))
</script>

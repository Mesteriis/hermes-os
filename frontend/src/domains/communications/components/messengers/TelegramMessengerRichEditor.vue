...
import { telegramMessengerComposerPreset, type MessengerComposerCapability } from './messengerComposer'
...
const preset = computed(() => telegramMessengerComposerPreset(props.conversation))
</script>

...
<template>
	<aside
		class="communication-workspace-panel communication-workspace-panel--inspector mail-inspector channel-inspector"
		:aria-label="t('Channel inspector')"
	>
		<div class="communication-workspace-panel__body">
			<div class="mail-inspector__content channel-inspector__content">
				<section class="mail-inspector-section mail-inspector-section--intelligence channel-inspector-section">
					<header class="mail-inspector-section__header">
						<div class="mail-inspector-section__title-row">
							...
							<h2 class="mail-inspector-section__title">{{ t('Channel Intelligence') }}</h2>
						</div>
				...
				<section class="mail-inspector-section channel-inspector-section">
					<header class="mail-inspector-section__header">
						<div class="mail-inspector-section__title-row">
							<Icon icon="tabler:circles-relation" size="1rem" class="mail-inspector-section__title-icon" />
							<h2 class="mail-inspector-section__title">{{ t('Extracted entities') }}</h2>
						</div>
					</header>
					...
					<div v-if="model.topics.length" class="mail-inspector-topic-row" :aria-label="t('Topics')">
						<Badge
				...
				<section class="mail-inspector-section channel-inspector-section">
					<header class="mail-inspector-section__header">
						<div class="mail-inspector-section__title-row">
							...
							<h2 class="mail-inspector-section__title">{{ t('Suggested actions') }}</h2>
						</div>
					</header>
				...
				<section class="mail-inspector-section channel-inspector-section">
					<header class="mail-inspector-section__header">
						<div class="mail-inspector-section__title-row">
							...
							<h2 class="mail-inspector-section__title">{{ t('Related context') }}</h2>
						</div>
					</header>

...
<template>
	<aside class="communication-workspace-panel communication-workspace-panel--inspector mail-inspector" :aria-label="t('Mail inspector')">
		<div class="communication-workspace-panel__body">
			<div class="mail-inspector__content">
				<section class="mail-inspector-section mail-inspector-section--intelligence">
					<header class="mail-inspector-section__header">
						<div class="mail-inspector-section__title-row">
							...
							<h2 class="mail-inspector-section__title">{{ t('Email Intelligence') }}</h2>
						</div>
				...
				<section class="mail-inspector-section">
					<header class="mail-inspector-section__header">
						<div class="mail-inspector-section__title-row">

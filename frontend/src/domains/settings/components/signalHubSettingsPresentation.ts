...
export type SignalHubView = 'graph' | 'inventory'

export interface SignalHubViewPresentation {
  icon: string
  ariaLabel: string
  eyebrow: string
  title: string
...
export function signalHubViewPresentation(view: SignalHubView): SignalHubViewPresentation {
  if (view === 'graph') {
    return {
      icon: 'tabler:route',

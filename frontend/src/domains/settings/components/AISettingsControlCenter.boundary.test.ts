...
describe('AISettingsControlCenter boundary', () => {
  it('renders AI Control Center from SettingsPage through explicit AI contracts', () => {
    ...
    expect(panel).toContain('providerModelGroups')
    expect(panel).toContain('settings-ai-model-provider-tabs')
    expect(panel).toContain('settings-ai-model-provider-tab')
    expect(panel).toContain('SearchInput')
    expect(panel).toContain('modelCatalogSearch')
    expect(panel).toContain('selectedModelGroupModels')
    expect(panel).toContain('settings-ai-model-checkbox')
    expect(panel).toContain('modelCapabilityBadges')
    expect(panel).toContain('modelRuntimeFacts')
    ...
    expect(wizard).toContain('Connection parameters')
    expect(wizard).toContain('Verification')
    expect(wizard).toContain('Model access')
